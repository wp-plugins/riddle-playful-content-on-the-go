...
//type
        ...
        $form  .= '<label><input type="radio" name="openLinks" id="openLinksYes" value="yes"   onchange="rid_change(\'\')">Open on riddle.com</label><br>';
        $form  .= '<label><input type="radio" name="openLinks" id="openLinksYes" value="no" checked  onchange="rid_change(\'\')">Open on your Website</label><br>'; 
