...
function riddleclosure3() {
    global $rservername;
    add_menu_page('Riddle Help', 'Riddle', 'manage_options', 'riddlemain', 'riddle_list', "../wp-content/plugins/Riddle/backend/images/icon.png");
    add_submenu_page("riddlemain", "My Riddles", "My Riddles", 'manage_options', 'riddlelogin', 'riddle_loginView');
    add_submenu_page("riddlemain", "All Riddles", "All Riddles", 'manage_options', 'allriddles', 'riddle_allRiddlesView');
    add_submenu_page("riddlemain", "Riddle Help", "Help", 'manage_options', 'riddlesub', 'riddle_list');
    
    /*   add_submenu_page("riddlemain", "Search Riddle", "Add Riddle", 'manage_options', 'riddle_search', 'riddle_search');
...
function rid_add_customposts_to_query($query) {
    if (is_home() && $query->is_main_query())
        $query->set('post_type', array('post', 'wp_riddlepost'));
    return $query;
}



//Add Metaboxes for the posttypes for direct embed
